...
public static class DbSeeder
{
    ...
    {
        if (await dbContext.Patients.AnyAsync()) return; // csak egyszer töltsük fel
        ...
        var patients = new List<Patient>
        {
            ...
            new() { Id = Guid.NewGuid(), Name = "Varga Dániel", Address = "Gyõr, Szent István út 22.", HealthInsuranceNumber = "567-890-123", Complaints = "Fülzúgás", CreatedAt = RandomDate() },
            new() { Id = Guid.NewGuid(), Name = "Kiss Júlia", Address = "Miskolc, Petõfi utca 9.", HealthInsuranceNumber = "678-901-234", Complaints = "Szédülés", CreatedAt = RandomDate() },
            ...
            new() { Id = Guid.NewGuid(), Name = "Fehér Levente", Address = "Kaposvár, Fõ utca 19.", HealthInsuranceNumber = "999-000-111", Complaints = "Hányinger", CreatedAt = RandomDate() },
            new() { Id = Guid.NewGuid(), Name = "Szûcs Dóra", Address = "Szekszárd, Béla király tér 3.", HealthInsuranceNumber = "000-111-222", Complaints = "Lábfájdalom", CreatedAt = RandomDate() }
        };
